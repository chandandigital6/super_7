<x-layouts::app :title="__('Content Blocks')">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Manage website dynamic content blocks from here.
                </p>
            </div>

            <a href="{{ route('content-blocks.create') }}"
                ...
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    ...
                    <thead class="bg-neutral-100 dark:bg-neutral-800">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-neutral-600 dark:text-neutral-300">Key</th>
                        ...
                        @forelse($contentBlocks as $block)
                            ...
                            <tr class="transition hover:bg-neutral-50 dark:hover:bg-neutral-800/60">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="mt-1 max-w-xl truncate text-xs text-neutral-500">
                                        {{ Str::limit(strip_tags($block->content), 80) }}
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <a href="{{ route('content-blocks.delete', $block) }}"
                                           onclick="return confirm('Delete this content block?')"
