<x-layouts::app :title="__('Advertisements')">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Manage website advertisements from here.
                </p>
            </div>
                ...
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    ...
                    <thead class="bg-neutral-100 dark:bg-neutral-800">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-neutral-600 dark:text-neutral-300">Image</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-neutral-600 dark:text-neutral-300">Title</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-neutral-600 dark:text-neutral-300">Position</th>
                            ...
                            <tr class="transition hover:bg-neutral-50 dark:hover:bg-neutral-800/60">
                                ...
                                <td class="px-6 py-4">
                                    @if($advertisement->image)
                                        <img src="{{ asset('storage/' . $advertisement->image) }}"
                                             class="h-14 w-24 rounded-xl object-cover border"
                                             alt="{{ $advertisement->title }}">
                                    @else
                                        <div class="flex h-14 w-24 items-center justify-center rounded-xl bg-neutral-100 text-xs text-neutral-400 dark:bg-neutral-800">
                                            No Image
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <a href="{{ route('advertisements.delete', $advertisement) }}"
