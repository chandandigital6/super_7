<div>
    <nav class="border-gray-200 bg-gradient-to-br from-blue-400 to-pink-700">
        <div class="flex flex-wrap items-center justify-center p-4 ">
           <a href="/"><img src="{{ asset('Logo(2).png') }}" width="150px" style="border-radius:60px" /></a>
        </div>
    </nav>
    <nav class="bg-white ">
        <div class="px-4 py-3 mx-auto md:px-6">
            <div class="flex items-center justify-center">
                <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                    ...
                    <li><a class="text-gray-900 hover:underline" aria-current="page" href="{{ route('chart') }}" >Chart</a>
                    </li>
